  ...
  return (
    <div>
      ...
      >
        ...
        <span className="absolute top-1/2 -translate-y-1/2 right-4 w-8 h-8 grid items-center justify-center border-current border group-hover:border-fg group-hover:bg-fg group-hover:text-bg rounded-full">
