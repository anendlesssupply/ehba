...
export const NavItem = ({
  ...
  const href = resolveHref(menuItem?.link?.linkType, menuItem?.link?.slug)
  if (!href) {
    return null
  }
...
export const MenuItemsRenderer = ({menuItems, isMobile}: {menuItems: any; isMobile: boolean}) => {
  const pathname = usePathname()
  return (
    <>
